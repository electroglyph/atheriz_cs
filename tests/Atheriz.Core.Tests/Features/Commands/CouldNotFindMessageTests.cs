// "Could not find" message: follow, group add, and socials target share one
// helper; the give "...here." variant stays out.
using Atheriz.Core;
...
[Collection("Ported")]
public sealed class CouldNotFindMessageTests
{
