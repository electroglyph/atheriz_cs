...
// Settable properties dispatch through the explicit per-type switch with
// the same accepted inputs and failures the old Convert.ChangeType path
// had, including widened numerics; unknown names still land in extras.
[Collection("Ported")]
public sealed class SetPropertyConversionTests
{
