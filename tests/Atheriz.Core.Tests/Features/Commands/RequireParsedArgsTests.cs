// Shared RequireParsedArgs guard: the guard sends the same PrintHelp output
// the fourteen hand-rolled preambles sent for null and non-ParsedArgs input.
// The first group covers ban/unban, build, channel, create; the second covers
// delete, desc, door, emote, get; the third covers give, say, set, unset. Every fact resolves its job through the real
...
[Collection("Ported")]
public sealed class RequireParsedArgsTests
{
