// Pins for simplify3 B20a parser-reset cleanup: SetKey/SetDesc assign
// directly and the help text rebuilds on the new key without throwing.
...
[Collection("Ported")]
public sealed class B20aParserResetTests
{
    [Fact]
