...
{
    private sealed class GridInsertProbeNode : Node
    {
        public GridInsertProbeNode(Coord coord) : base(coord) { }
    }

    static NodeAreaGridInsertTailTests()
    {
        Node.RegisterPersistedSubtype("GridInsertTailProbe", typeof(GridInsertProbeNode), c => new GridInsertProbeNode(c));
    }
    ...
    public void ToDomain_SubtypeAndPlain_InsertAtCoordDerivedKeys()
    {
        ...
        var sub = new NodeDto { Coord = new Coord("b22tail", 7, 8, 0), Name = "Sub", Id = 6102, ObjectType = "GridInsertTailProbe" };
        ...
        Assert.IsType<GridInsertProbeNode>(grid.Nodes[(7, 8)]);
    ...
    public void ToDomain_BothBranches_HydrateFieldsAndIds()
    {
        ...
        var sub = new NodeDto
        {
            ...
            Theme = "sub-theme", Symbol = "sub-sym", Id = 6202, ObjectType = "GridInsertTailProbe",
        };
        ...
        var subNode = Assert.IsType<GridInsertProbeNode>(grid.Nodes[(3, 4)]);
