...
public class AccountDeletionTests
{
    ...
    public void Delete_ViaGameObjectRef_DeletesRowLikeBoolPath()
    {
        ...
        var savedCreateHook = Account.AtCreateHook;
        var savedDeleteHook = Account.AtDeleteHook;
        try
        {
            Account.AtCreateHook = null;
            Account.AtDeleteHook = null;
        ...
        {
            Account.AtCreateHook = savedCreateHook;
            Account.AtDeleteHook = savedDeleteHook;
        }
    }
}
